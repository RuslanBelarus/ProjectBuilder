...
@builder.Generation
def index():
    [History, Dishes, Trends]
    builder.SetCss('#label', 'backgroundColor', '#ff1717')
    builder.SetCss('#sublabel', 'backgroundColor', '#f01616')

    builder.SetCss('#label', 'color', 'white')
    builder.SetCss('#sublabel', 'color', 'white')

    builder.SetCss('.chptdescribe', 'paddingLeft', '15%')
    builder.SetCss('.chptdescribe', 'paddingRight', '15%')

    builder.SetCss('.chptname', 'backgroundColor', '#ff3030')
    builder.SetCss('.chptname', 'color', 'white')

    builder.SetCss('body', 'backgroundColor', '#ebebeb')
